/*
 * [Game.java]
 * Author: Feng, Victor, David, Armanya, Arjun
 * Date: June.13
 * Purpose: Class that generates menu, and creates the actual game
 */
...
//  }
   ...
   * @return Returns string array of blocks
   */
  ...
  /**
   * getCollision
   * @param Takes in 2D string array of blocks
   * @return Returns 2D array of collisions
   */
